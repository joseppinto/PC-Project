...
\xymatrix@C=3cm{
    \ensuremath{\Conid{Blockchain}}
           \ar[d]_-{\ensuremath{\Varid{allTransactions}\mathrel{=}\cata{\Varid{g}\comp (\p2\comp \p2\times\Varid{id})}}}
&
    \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\times\Conid{Blockchain}}
           \ar[d]^{\ensuremath{\p2\comp \p2\mathbin{+}\p2\comp \p2\times\Varid{allTransactions}}}
...
&
     \ensuremath{\Conid{Transactions}\mathbin{+}\Conid{Transactions}\times\Conid{Transactions}}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{id}}{\mathsf{conc}}}}
}
\end{eqnarray*}
...
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{Transaction}\times\Conid{Transactions}}
           ...
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{id}}{\Varid{cons}}}}
\\
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{Bool}\times\Conid{Bool}}
           \ar[l]_-{\ensuremath{\alt{\Conid{True}}{\Varid{el}}}}
\\
     \ensuremath{[\mskip1.5mu \Conid{Bool}\mskip1.5mu]}
          \ar[u]_-{\ensuremath{\cata{\alt{\Conid{True}}{\Varid{e}}}}}
          \ar[r]^-{\ensuremath{\Varid{outList}}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{Bool}\times[\mskip1.5mu \Conid{Bool}\mskip1.5mu]}
           \ar[u]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\cata{\alt{\Varid{true}}{\Varid{e}}}}}
           \ar[l]^-{\ensuremath{\alt{\Varid{nil}}{\Varid{cons}}}}
\\
    \ensuremath{[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]}
          \ar[u]_-{\ensuremath{\ana{(\Varid{id}\mathbin{+}\conj{\neg \comp \Varid{el}}{\p2})\comp \Varid{outList}}}}
          \ar[r]^-{\ensuremath{\Varid{outList}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{MagicNo}\times[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]}
          \ar[u]^{\ensuremath{\Varid{id}\mathbin{+}(\neg \comp \Varid{el})\times\ana{(\Varid{id}\mathbin{+}\conj{\neg \comp \Varid{el}}{\p2})\comp \Varid{outList}}}}
          \ar[l]^-{\ensuremath{\alt{\Varid{nil}}{\Varid{cons}}}}
\\
    \ensuremath{\Conid{Blockchain}}
          \ar[u]_-{\ensuremath{\cata{\alt{\Varid{cons}\comp \conj{\p1}{\Varid{nil}}}{\Varid{cons}\comp (\p1\times\Varid{id})}}}}
&
    \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\times\Conid{Blockchain}}
          \ar[u]^{\ensuremath{\p1\mathbin{+}\p1\times\cata{\alt{\Varid{cons}\comp \conj{\p1}{\Varid{nil}}}{\Varid{cons}\comp (\p1\times\Varid{id})}}}}
          \ar[l]_-{\ensuremath{\Varid{inBlockchain}\mathrel{=}\alt{\Conid{Bc}}{\Conid{Bcs}}}}
}
\end{eqnarray*}
...
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\Varid{n}\;\Varid{tree}\mathrel{=}\Varid{anaQTree}\;\Varid{transformaTree}\;(\Varid{nn}\;\Varid{n},\Varid{tree}){}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mathbf{where}\;\Varid{h}\mathrel{=}\Varid{depthQTree}\;\Varid{tree}{}\<[E]%
\\
\>[21]{}\hsindent{6}{}\<[27]%
\>[27]{}\Varid{nn}\mathrel{=}\Varid{cond}\;(\mathbin{>}\Varid{h})\;\underline{\mathrm{0}}\;\underline{(\Varid{h}\mathbin{-}\Varid{n})}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{14}{}\<[14]%
\>[14]{}\mathbf{where}\;\Varid{initype}\mathrel{=}\conj{\underline{\mathrm{30.0}}}{\Varid{id}}{}\<[E]%
\\[\blanklineskip]%
...
\column{30}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{singletonbag}\;\Varid{x}\mathrel{=}\mathit B\;[\mskip1.5mu (\Varid{x},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
